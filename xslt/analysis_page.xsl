                    ...
                    <div class="text-box dropdownContent show" id="methods-text">
                        <div>
                            ...
                            <p>We already knew, from prior study of her poetry, that Dickinson often
                                wrote about nature, religion, and emotion, so we expected to mark up
                                these areas of imagery. Apart from these known common themes,
                                however, we were unsure of what exactly we would mark up up in terms
                                of imagery.</p>
                            ...
                            <p>We also included "subcategories" for some of these themes. For
                                ...
                                they are still available in the source code on our <a
                                    href="https://github.com/cngish98/Language-of-Dickinson"> Github
                                    repository</a>.</p>
                            ...
                            <p>Inevitably, because ellipsis is the occurrence of a word or words not
                                actually present in a text, we had to come up with a way to show
                                what was absent before even beginning markup of ellipsis. For our
                                purposes with Emily Dickinson’s poems, we decided an empty
                                &lt;ellipsis&gt; element with attributes giving additional
                                information about the elided material would be the best course of
                                action.</p>

                            <p>Each &lt;ellipsis&gt; element <em>required</em> an @ellipsis_type
                                attribute with an allowed value of ‘nominal,’ ‘verbal,’ ‘clausal,’
                                or ‘ambiguous.’ Additional <em>optional</em> attributes were:</p>

                            <ul>
                                <li><strong>@elided_pos:</strong> specific part of speech of elided
                                    material if type of ellipsis was ‘nominal’ or ‘verbal’ (unused
                                    in the current project but available in the source code in our
                                        <a href="https://github.com/cngish98/Language-of-Dickinson">
                                        Github repository</a>)</li>
                                <li><strong>@subject_string:</strong> the subject of the elided verb
                                    or verb phrase (unused in the current project but available in
                                    the source code in our <a
                                        href="https://github.com/cngish98/Language-of-Dickinson">
                                        Github repository</a>)</li>
                                <li><strong>@possible_string:</strong> Developer’s suggestion of
                                    what the possible elided string would be in the determined
                                    location of ellipsis (Some elided strings are recoverable based
                                    on the poem’s linguistic and theme-based contexts, while others
                                    are not. If a possible string was not recoverable, this
                                    attribute was excluded.)</li>
                                <li><strong>@v:</strong> Marks an instance of ellipsis as a version
                                    with a number. This attribute is only included if a poem has
                                    multiple readings depending on where the ellipsis is placed. For
                                    example, if a poem has two readings (as a result of ellipsis), then the ellipsis providing
                                    the first reading will be tagged as v1, and the ellipsis providing
                                    the second reading will be tagged as v2. Poems with instances of ellipsis
                                    that only have a singular reading do not have this attribute.
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li><strong>Nominal:</strong> elided material is a noun or a noun
                                    phrase</li>
                                <li><strong>Verbal:</strong> elided material is a verb or a verb
                                    phrase</li>
                            ...
                            <p>We were mainly looking for more unconventional instances of ellipsis
                                present in Dickinson’s poems. As such, elided understood “you”
                                subjects of imperative statements were not marked up as instances of
                                ellipsis. </p>

                            <p>After the entirety of each poem was examined and marked up for
                                instances of ellipsis, the value of ‘yes,’ ‘no,’ or ‘ambiguous’ was
                                inputted for the &lt;ellipsis_present&gt; element of
                                &lt;metadata&gt; section.</p>

                            <p>Each instance of ellipsis is marked by a […] in the reading view of
