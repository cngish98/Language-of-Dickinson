                    ...
                    <div class="text-box dropdownContent show" id="methods-text">
                        <div>
                            ...
                            <p>Inevitably, because ellipsis is the occurrence of a word or words not 
                                actually present in a text, we had to come up with a way to show what 
                                was absent before even beginning markup of ellipsis. For our purposes 
                                with Emily Dickinson’s poems, we decided an empty &lt;ellipsis&gt; element 
                                with attributes giving additional information about the elided 
                                material would be the best course of action.</p>
                            
                            <p>Each &lt;ellipsis&gt; element <em>required</em> an @ellipsis_type 
                                attribute with an allowed value of ‘nominal,’ ‘verbal,’ ‘clausal,’ or 
                                ‘ambiguous.’ Additional <em>optional</em> attributes were:</p>
                            
                            <ul>
                                <li><strong>@elided_pos:</strong> specific part of speech of elided material if type of 
                                    ellipsis was ‘nominal’ or ‘verbal’ (unused in the current project but 
                                    available in the source code in our <a
                                        href="https://github.com/cngish98/Language-of-Dickinson">
                                        Github repository</a>)</li>
                                <li><strong>@subject_string:</strong> the subject of the elided verb or verb phrase
                                    (unused in the current project but available in the source 
                                    code in our <a
                                        href="https://github.com/cngish98/Language-of-Dickinson">
                                        Github repository</a>)</li>
                                <li><strong>@possible_string:</strong> Developer’s suggestion of what the possible elided string 
                                    would be in the determined location of ellipsis (Some elided strings are 
                            ...
                            <ul>
                                <li><strong>Nominal:</strong> elided material is a noun or a noun phrase</li>
                                <li><strong>Verbal:</strong> elided material is a verb or a verb phrase</li>
                                <li><strong>Clausal:</strong> elided material is either both a verb/verb phrase 
                                    <em>and</em> a noun/noun phrase or a word that join clauses of a sentence (such
                                    as a conjunction)</li> 
                                <li><strong>Ambiguous:</strong> there is elided material, but type cannot be determined</li>
                            </ul>
                            
                            <p>We were mainly looking for more unconventional instances of ellipsis present in 
                                Dickinson’s poems. As such, elided understood “you” subjects of imperative statements 
                                were not marked up as instances of ellipsis. </p>
                            
                            <p>After the entirety of each poem was examined and marked up for instances of ellipsis, 
                                the value of ‘yes,’ ‘no,’ or ‘ambiguous’ was inputted for the &lt;ellipsis_present&gt; 
                                element of &lt;metadata&gt; section.</p>
                            
                            <p>Each instance of ellipsis is marked by a […] in the reading view of the Corpus 
                                page. When you mouse over the […], a tooltip pops up first providing information 
                                about the possible elided string and then providing the type of ellipsis in 
                                parentheses. For instances of ellipsis</p>
