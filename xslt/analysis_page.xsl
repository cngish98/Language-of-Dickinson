                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li><strong>@v:</strong> Marks an instance of ellipsis as a version
                                    ...
                                    example, if a poem has two readings, then the ellipsis providing
                                    the first reading will tagged as v1, and the ellipsis providing
                                    the second reading will be tagged as v2. Instances of ellipsis
