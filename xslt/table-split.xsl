            ...
            <body>
                ...
                <h2>Search for poems here</h2>
                 ...
                 <!--   <xsl:apply-templates select="$poems_corpus//metadata"/> -->
                    ...
                    <xsl:for-each-group select="$poems_corpus" group-by="//date/@period">
                        <h3>Period: <xsl:value-of select="current-grouping-key()"/></h3>
                        <table> 
                            <tr>
                            ...
                            <xsl:apply-templates select="current-group()//metadata"/>
                        </table>
                    </xsl:for-each-group>
