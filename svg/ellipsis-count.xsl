    ...
    <xsl:template name="xsl:initial-template">
        <svg height="800" width="1200">
            <g transform="translate(80,600)">
                ...
                <!-- y-axis label -->
                <text x="-50" y="-{$max-height * $y-scale div 2}" text-anchor="middle" writing-mode="tb" font-size="x-large"># of Poems</text>
                
                <!-- title (x-axis) -->
                <text x="{$max-width div 2}" y="80" text-anchor="middle" font-size="x-large">Ellipsis Presence</text>
